...
public class TutorialDriver : MonoBehaviour
{
    ...
    private void InitializeTutorialDialogue()
    {
        dialogue = new List<string>
        {
            ...
            /*9*/ "Tap on your antibody to enter binding mode.",
            /*10*/ "With binding mode, you can bind to any cell and mark it to be destroyed. But be careful! We only want to destroy the cancer cells. Try binding to a cancer cell.",
